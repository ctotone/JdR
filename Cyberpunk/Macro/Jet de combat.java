...
&{template:custom&#125;{{title=&#125;&#125;{{color=red&#125;&#125;{{SD = Jet d'Esquive de la cible&#125;&#125;{{Dégâts arme de mêlée=  &#125;&#125;{{ Légère = [1D6](! #1D6) (CAD 2)&#125;&#125;{{Intermédiaire = [2D6](! #2D6) (CAD 2)&#125;&#125;{{Lourde = [3D6](! #3D6) (CAD 2)&#125;&#125;{{Trés lourde = [4D6](! #4D6)&#125;&#125;{{=L'attaque de mêlée ignore la moitié de l'armure de la cible en cas de réussite&#125;&#125;
