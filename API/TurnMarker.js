        ...
        if(state.TurnMarker.announceTurnChange ) {
            ...
            if(previousToken && previousToken.get('showplayers_name')) {
                pNameString='<span style=\''+
                    ...
                    '</span> a terminé son tour.';                
            }
            
            var cNameString='Passage au tour suivant!';
            ...
            sendChat(
                '', 
                "/direct "+
                "<div style='border: 3px solid #b01f1f; background-color: #b01f1f; color: white; padding: 1px 1px;'>"+
