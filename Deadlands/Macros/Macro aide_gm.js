...
,|
Secoué,/w gm &{template:custom&#125;{{title=Secoue&#125;&#125;{{=Les personnages Secoués sont choqués&#44; distraits ou momentanément ébranlés. Ils ne sont pas sonnés ou incapables de réagir&#44; mais suffisamment affectés pour avoir besoin de reprendre leurs esprits.&#125;&#125;{{Ame=En cas d’échec&#44; il demeure Secoué. Il ne peut faire que des actions gratuites (voir p. 109) 
...
,|
Actions,/w gm &{template:custom&#125;{{title=Actions&#125;&#125;{{=Les personnages peuvent se deplacer et faire une action sans pénalité.
...
,|
Gabarit,/w gm &{template:custom&#125;{{title=Gabarit&#125;&#125;{{Petit=Cercle de 4m de diametre.&#125;&#125;{{Moyen=8m de diametre.&#125;&#125;{{Grand=12m de diametre.&#125;&#125;,
|
Dégâts,/w gm &{template:custom&#125;{{title=Dégâts&#125;&#125;{{Aucun=L’attaque&#44; bien qu’ayant touché&#44; n’a pas blessé la cible (jet de dégâts trop faible par rapport à la résistance de la cible)&#125;&#125;{{0 relance=La cible de l’attaque est Secouée. (aucun changement si déjà secouée)
Cela signifie qu’elle est choquée&#44; distraite ou ébranlée. 
Cependant cela n’occasionne pas de Blessure.&#125;&#125;{{1 relance 
et plus=Chaque relance sur le jet de dégâts occasionne 1 blessure à la cible.&#125;&#125;{{desc=Les Extras (PNJ de base) subissant une blessure sont retirés du jeu. Ils sont morts ou blessés gravement&#44; mais quoi qu’il en soit sont hors de combat.

Un Joker (les PJ et PNJ importants) peut subir trois blessures avant d’être dans un État critique (ce qui arrive lors de la quatrième blessure)&#125;&#125;
|
Options de combat,/w gm &{template:custom&#125;{{title=Options de combat&#125;&#125;{{=On ne va pas jouer toutes les règles de combat à la lettre au début&#44; je vais lister ici les règles qui seront utilisées. On ajoutera des nuances au fil des parties si besoin.&#125;&#125;{{Recharger=Cela prend un round. On peut accélérer et tirer dans le même round mais avec la pénalité de -2 pour Action Multiple.&#125;&#125;{{A terre=Si tu te couches au sol&#44; l'attaquant aura un malus de -2.&#125;&#125;{{Plusieurs=Si tu attaques une cible au corps à corps à plusieurs&#44; chaque attaquant supplémentaire ajoute +1 à tous les jets de combat des attaquants (limite de +4).&#125;&#125;{{CdT=Un personnage muni d’une arme à double action (un Colt Peacemaker&#44; par exemple) peut tirer deux coups en une action. Il effectue un simple jet de Tir avec un bonus de +1&#44; et en cas de succès&#44; les dégâts bénéficient également d’un bonus de +1. 
Tirer en rafale nécessite une CdT de 3 et octroie un bonus de +2 au jet de Tir et aux dégâts.&#125;&#125;{{Tir auto.=Les tirs en mode automatique (avec n’importe quelle arme ayant une Cadence de Tir supérieure ou égale à 2) sont moins précis que les autres. Le tireur subit un malus de -2 à son jet de Tir avec une telle arme. &#125;&#125;{{Ventiler=Un flingueur qui veut « ventiler » actionne la détente d’un pistolet à simple action tandis qu’avec son autre main&#44; il ramène en arrière et de façon répétée le chien. Si le chargeur est rempli&#44; cela peut tirer 6 fois en une seule action. Par contre cela entraine un malus de -4 à chaque tir.
...
|
Épreuve Volonté,/w gm &{template:custom&#125;{{title=Épreuves de volonté&#125;&#125;{{=Intimidation et Sarcasme permettent à un personnage d’initier des Épreuves de volonté.
...
|
Duel,/w gm &{template:custom&#125;{{title=Duel&#125;&#125;{{=Chaque duelliste reçoit 2 cartes.&#125;&#125;{{I=Confrontation où les duellistes font chacun un Jet de Sarcasme ou Intimidation en opposition avec la compétence de l'autre.

ÉGALITÉ : On donne une carte supplémentaire aux deux et on recommence.
PERDANT : Perd ses moyens et aura un malus de -2 à son jet de Tir.&#125;&#125;{{II=Trois cartes (face découverte) sont mises sur la table et deux autres faces cachées.
Dés qu'un duelliste pense qu'il a une bonne main&#44; il crie "TIR".&#125;&#125;{{III=Chaque duelliste décide si il privilégie vitesse ou précision.
...
|
Savant fou,/w gm &{template:custom&#125;{{title=Savant fou&#125;&#125;{{=En cas de 1 sur un jet pour un gadget (qu'importe le resultat du dés Joker)&#44; l'objet explose ou se casse en infligeant 2D6 de dégâts dans un gabarit moyen (8m)&#125;&#125;
|
Sort Explosion,/w gm &{template:custom&#125;{{title=Explosion&#125;&#125;{{2PP=2D6 de dégâts de zone de la taille d'un Gabarit moyen (8m).&#125;&#125;{{4PP=3D6 de dégâts ou zone de Grand Gabarit (12m).&#125;&#125;{{6PP=3D6 de dégâts et Grand Gabarit (12m)&#125;&#125;{{desc=Les relances sur les dés n'ajoutent pas de dégâts supplémentaires&#125;&#125;
|
Sort Invisibilité,/w gm &{template:custom&#125;{{title=Invisibilité&#125;&#125;{{Succés au jet=Le personnage est transparent mais sa silouhette est visible. Il est possible de le détecter en ayant une raison de se douter de sa présence et en réussissant un jet de Perception avec un malus de -4.&#125;&#125;{{Relance au jet=Le personnage est totalement invisible et la pénalité passe à -6.&#125;&#125;{{Multi-cibles=Le personnage peut affecter jusqu'à 5 cibles en dépensant 5PP par cible.&#125;&#125;{{desc=Le pouvoir affecte les objets qu'il transporte.&#125;&#125;
}
